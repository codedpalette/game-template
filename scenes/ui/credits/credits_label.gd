...
## Script for parsing a credits file in markdown format.
...
## The path to the credits file in markdown format.
@export_file("*.md") var credits_file_path: String
## If true, update the content of the text label from the credits file when ready.
...
## The maximum width in pixels of any images loaded from the credits file.
@export var max_image_width: int
## The maximum height in pixels of any images loaded from the credits file.
@export var max_image_height: int
@export_group("Extra Options")
## If true, disable reading images from the credits file.
@export var disable_images: bool = false
## If true, disable reading URLs from the credits file.
